...
async function identifySong() {
    await $`yes | cp ../Music/stream.flac ../Music/stream_temp.flac  && ffmpeg -sseof -6 -y -i ../Music/stream_temp.flac -ab 320k -id3v2_version 3 ../Music/stream/last_six_seconds.mp3 && rm ../Music/stream_temp.flac`
